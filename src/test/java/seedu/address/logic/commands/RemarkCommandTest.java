...
public class RemarkCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        ...
        RemarkCommand remarkCommand = new RemarkCommand(indexLastPerson, new Remark(VALID_REMARK_BASEBALL));
    ...
    public void execute_invalidIndexUnfilteredList_throwsCommandException() {
        ...
        RemarkCommand remarkCommand = new RemarkCommand(outOfBoundIndex, new Remark(VALID_REMARK_BASEBALL));
    ...
    public void execute_validIndexFilteredList_success() {
        ...
        RemarkCommand remarkCommand = new RemarkCommand(INDEX_FIRST_PERSON, new Remark(VALID_REMARK_COOKING));
